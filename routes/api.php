...
Route::prefix('v1')->group(function () {
    ...
    // Atzīmē ar “patīk” saturu (nepieciešama autorizācija, bet pieejamības nodrošināšanai jābūt publiskajā sadaļā)
    Route::post('/content/{id}/like', [ContentController::class, 'toggleLike'])->middleware('auth:sanctum');

    // Atsauksmes (publiski lasāmas)
    Route::get('/reviews/{type}/{id}', [ReviewController::class, 'byReviewable']);

    // Komentāri (publiski lasāmi)
