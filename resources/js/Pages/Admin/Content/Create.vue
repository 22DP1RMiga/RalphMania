...
const regenerateSlug = () => {
    if (form.title_lv) {
        form.slug = generateSlug(form.title_lv);
    }
};
...
const handleThumbnailUpload = (event) => {
    ...
    if (file) {
        processImageFile(file, 'thumbnail');
    }
};
...
const handleFeaturedImageUpload = (event) => {
    const file = event.target.files[0];
    if (file) {
        processImageFile(file, 'featured');
    }
};
...
const handleBlogImagesUpload = (event) => {
    ...
    files.forEach(file => {
        processImageFile(file, 'blog');
    });
};

const processImageFile = (file, type) => {
    if (!file.type.startsWith('image/')) {
        alert(t('admin.content.form.invalidImageType'));
        return;
    }
...
const handleDrop = (event, type) => {
    ...
    if (type === 'blog') {
        ...
        if (files[0]) processImageFile(files[0], type);
    }
};
...
<template>
    <Head :title="t('admin.content.create.title')" />
        ...
        <div class="page-header">
            <div class="header-left">
                ...
                <div class="header-info">
                    <p class="header-subtitle">{{ t('admin.content.create.subtitle') }}</p>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <input
                                        v-model="form.title_lv"
                                        type="text"
                                        class="form-input"
                                        :class="{ 'is-invalid': form.errors.title_lv }"
                                        :placeholder="t('admin.content.form.titleLvPlaceholder')"
                                        required
                                    >
                                    <span v-if="form.errors.title_lv" class="error-text">
                                        {{ form.errors.title_lv }}
                                    </span>
                                </div>

                                <div class="form-group">
                                    <label class="form-label">
                                        {{ t('admin.content.form.titleEn') }}
                                    </label>
                                    <input
                                    ...
                                    >
                                    <span v-if="form.errors.title_en" class="error-text">
                            ...
                            <div class="form-group">
                                ...
                                <div class="slug-input-wrapper">
                                    ...
                                    <input
                                        ...
                                        :placeholder="t('admin.content.form.slugPlaceholder')"
                                        required
                                    >
                                    <button
                                        type="button"
                                ...
                                <span v-if="form.errors.slug" class="error-text">
                                    {{ form.errors.slug }}
                                </span>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    >
                                    <span v-if="form.errors.video_url" class="error-text">
                                ...
                                <div class="form-group">
                                    <label class="form-label">
                                        {{ t('admin.content.form.videoPlatform') }}
                                    </label>
                            ...
                            <div class="form-group">
                                ...
                                <p class="form-hint">{{ t('admin.content.form.durationHint') || 'Video ilgums sekundēs (piem. 180 = 3 minūtes)' }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="lang-tabs">
                                <button
                                    type="button"
                                    :class="['lang-tab', { active: activeTab === 'lv' }]"
                                    @click="activeTab = 'lv'"
                                >
                                ...
                                <button
                                    type="button"
                                    :class="['lang-tab', { active: activeTab === 'en' }]"
                                    @click="activeTab = 'en'"
                                >
                        ...
                        <div class="card-body">
                            ...
                            <div v-show="activeTab === 'lv'" class="tab-content">
                                <div class="form-group">
                                    <label class="form-label">
                                        {{ t('admin.content.form.descriptionLv') }}
                                    </label>
                                    <textarea
                                        v-model="form.description_lv"
                                        class="form-textarea"
                                        rows="3"
                                        :placeholder="t('admin.content.form.descriptionPlaceholder')"
                                    ></textarea>
                                </div>

                                <div class="form-group">
                                    <label class="form-label">
                                        {{ t('admin.content.form.contentLv') }}
                                    </label>
                                    <textarea
                                        v-model="form.content_body_lv"
                                        class="form-textarea content-editor"
                                        rows="12"
                                        :placeholder="t('admin.content.form.contentPlaceholder')"
                                    ></textarea>
                                </div>
                            </div>
                            ...
                            <div v-show="activeTab === 'en'" class="tab-content">
                                <div class="form-group">
                                    <label class="form-label">
                                        {{ t('admin.content.form.descriptionEn') }}
                                    </label>
                                    <textarea
                                ...
                                <div class="form-group">
                                    <label class="form-label">
                                        {{ t('admin.content.form.contentEn') }}
                                    </label>
                                    <textarea
                                        v-model="form.content_body_en"
                                        class="form-textarea content-editor"
                                        rows="12"
                                        :placeholder="t('admin.content.form.contentPlaceholder')"
                                    ></textarea>
                    ...
                    <div v-if="isBlogType" class="card">
                        ...
                        <div class="card-body">
                            <div
                                ...
                                :class="{ 'dragging': isDraggingBlogImages }"
                                @dragover="handleDragOver($event, 'blog')"
                                @dragleave="handleDragLeave('blog')"
                                @drop="handleDrop($event, 'blog')"
                            >
                                <input
                                    type="file"
                                    @change="handleBlogImagesUpload"
                                    accept="image/*"
                                    multiple
                                ...
                                <label for="blog-images-input" class="dropzone-label">
                                    ...
                                    <span>{{ t('admin.content.form.dragDropImages') || 'Ievelciet attēlus šeit' }}</span>
                                    <span class="dropzone-hint">{{ t('admin.content.form.orClickToSelect') || 'vai klikšķiniet, lai izvēlētos' }}</span>
                                </label>
                            </div>

                            <div v-if="blogImagesPreview.length > 0" class="image-gallery">
                                <div
                                    v-for="(preview, index) in blogImagesPreview"
                                    :key="index"
                                    class="gallery-item"
                                >
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                ...
                                {{ t('admin.content.form.publishSettings') || 'Publicēšanas iestatījumi' }}
                            </h3>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label class="form-label">
                                    {{ t('admin.content.form.publishedAt') }}
                                </label>
                                <input
                                    ...
                                    class="form-input"
                                >
                                <p class="form-hint">{{ t('admin.content.form.publishedAtHint') || 'Atstājiet tukšu, lai publicētu uzreiz' }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div v-if="isVideoType" class="card">
                        ...
                        <div class="card-body">
                            <div
                                ...
                                @dragover="handleDragOver($event, 'thumbnail')"
                                @dragleave="handleDragLeave('thumbnail')"
                            ...
                            <p class="form-hint">{{ t('admin.content.form.thumbnailHint') || 'Ieteicamais izmērs: 1280x720px' }}</p>
                        </div>
                    </div>

                    <!-- Featured Image (for blogs/news) -->
                    <div v-if="!isVideoType" class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                <i class="fas fa-image"></i>
                        ...
                        <div class="card-body">
                            <div
                                ...
                                class="dropzone"
                                :class="{ 'dragging': isDraggingFeatured }"
                                @dragover="handleDragOver($event, 'featured')"
                                @dragleave="handleDragLeave('featured')"
                            ...
                            <p class="form-hint">{{ t('admin.content.form.featuredImageHint') || 'Ieteicamais izmērs: 1200x630px' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            >
                                ...
                                {{ form.processing ? t('admin.common.saving') : t('admin.content.form.save') }}
                            </button>
                        </div>
                    </div>
                </div>
...
.dropzone:hover .dropzone-label i,
.dropzone.dragging .dropzone-label i {
    color: #dc2626;
}
